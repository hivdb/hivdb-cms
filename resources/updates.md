...
- Associated genotype-phenotype [Dataset] imported (/cgi-bin/Reference.cgi?linkout=PubMed&PubMedID=31135883)


## March 2021

**Program/Algorithm Updates:**
...
- **[Sierra 3.1.1](/page/program-updates/#version.3.1.1.update.2021-03-21)** - Bugfix release. See [program release notes](/page/program-updates/#version.3.1.1.update.2021-03-21) for more details.
- **[Sierra 3.1.2](/page/program-updates/#version.3.1.2.update.2021-03-21)** - Bugfix release. See [program release notes](/page/program-updates/#version.3.1.2.update.2021-03-21) for more details.

## February 2021

**Database update:**
- New cabotegravir susceptibility data: [Smith20](https://hivdb.stanford.edu/cgi-bin/Reference.cgi?RefID=3011&Gene=IN&Species=HIV1&Group=M&Type=Lab) and  [Rizzardini20](https://hivdb.stanford.edu/cgi-bin/Reference.cgi?RefID=3010&Gene=IN&Species=HIV1&Group=M&Type=Clinical)
...
**Database update:**
- HIVDB: 10 new studies entered 
- GenBank: 19 new GenBank submissions imported
